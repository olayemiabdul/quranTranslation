...
class EngArabicTextPage extends StatefulWidget {
  ...
  const EngArabicTextPage({super.key, required this.ayahs, required this.ayahstext, required this.surahEnglishName, required this.numberInSurah, required this.surahEnglishNameT, required this.numberInSurahT,});

  @override
  State<EngArabicTextPage> createState() => _EngArabicTextPageState();
}

class _EngArabicTextPageState extends State<EngArabicTextPage> {
